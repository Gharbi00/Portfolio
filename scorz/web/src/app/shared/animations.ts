...
export const fadeAnimations = [
  trigger('scaleAnimation', [
    ...
    transition('* => open', [animate('1s ease')]),
  ]),

  trigger('tabAnimation', [
    transition(':enter', [style({ opacity: 0, transform: 'scale(0.8)' }), animate('300ms ease-in', style({ opacity: 1, transform: 'scale(1)' }))]),
  ...
  trigger('fadeUpCustomAnimation', [
    state('void', style({ opacity: 1, transform: 'translate3d(0, 0px, 0)' })),
    transition('void => *', [animate('{{ delay }}s ease', style({ opacity: 0, transform: 'translate3d(0, -30px, 0)' }))], { params: { delay: '1' } }),
  ]),

  trigger('fadeDownCustomAnimation', [
    state('void', style({ opacity: 0, transform: 'translate3d(0, -30px, 0)' })),
    transition('void => *', [animate('{{ delay }}s ease', style({ opacity: 1, transform: 'translate3d(0, 0, 0)' }))], { params: { delay: '1' } }),
  ]),
