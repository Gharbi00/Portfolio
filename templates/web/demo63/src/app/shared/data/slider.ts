...
export let ProductCarousel:OwlOptions={
    ...
    navText:['<ul class="slick-custom-arrow"><li class="left-arrow"><i class="fa fa-angle-left" aria-hidden="true"></i></li></ul>','<ul class="slick-custom-arrow"><li class="right-arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></li></ul>']
};
...
export let NewProductsCarousel2:OwlOptions={
    ...
    navText:['<button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="display: block;">Previous</button>'
