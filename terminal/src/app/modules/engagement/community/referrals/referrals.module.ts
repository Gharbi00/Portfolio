...
import { ReferralsListComponent } from './list/list.component';
import { SharedModule } from '../../../../shared/shared.module';
import { ReferralsComponent } from './referrals.component';
import { ReferralsResolver } from './referrals.resolvers';
...
@NgModule({
  ...
  declarations: [ReferralsComponent, ReferralsListComponent],
  imports: [
