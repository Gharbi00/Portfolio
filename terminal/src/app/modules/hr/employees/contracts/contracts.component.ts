...
import { customerModel } from './contracts.model';
import { Customers } from './data';
import { CustomersService } from './contracts.service';
import { NgbdAdvancedSortableHeader, SortEvent } from './contracts-sortable.directive';
...
export class ContractsComponent {
  ...
  ngOnInit(): void {
    ...
    this.translate.get('MENUITEMS.TS.HR').subscribe((hr: string) => {
      this.translate.get('MENUITEMS.TS.CONTRACTS').subscribe((contracts: string) => {
        this.breadCrumbItems = [{ label: hr }, { label: contracts, active: true }];
      });
    });
