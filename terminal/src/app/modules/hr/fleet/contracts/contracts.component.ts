 ...
 * Customers Component
 */
export class VehiculeContractsComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    this.translate.get('MENUITEMS.TS.HR').subscribe((hr: string) => {
      this.translate.get('MENUITEMS.TS.CUSTOMERS').subscribe((customers: string) => {
        this.breadCrumbItems = [{ label: hr }, { label: customers, active: true }];
      });
    });
