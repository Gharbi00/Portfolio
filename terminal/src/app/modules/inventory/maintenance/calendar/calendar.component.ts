...
export class CalendarComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private translate: TranslateService, private formBuilder: FormBuilder, private datePipe: DatePipe) {}
  ...
  ngOnInit(): void {
    ...
    this.translate.get('MENUITEMS.TS.INVENTORY').subscribe((inventory: string) => {
      this.translate.get('MENUITEMS.TS.CALLENDAR').subscribe((calendar: string) => {
        this.breadCrumbItems = [{ label: inventory }, { label: calendar, active: true }];
      });
    });
