...
import { GoogleAnalyticsType, PluginType } from '@sifca-monorepo/terminal-generator';
...
export class GoogleResolver implements Resolve<any> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<GoogleAnalyticsType> {
    return this.integrationAppsService.getGoogleAnalyticsByTarget();
  }
}
