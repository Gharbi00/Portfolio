...
import { LoyaltySettingsWalletCardType, QuestWithRepeatDateType, WidgetIntegrationType } from '@sifca-monorepo/widget-generator';
...
export class EmbedModeComponent implements OnInit, OnDestroy {
  ...
  statisticsPath = this.baseUrl + '/assets/img/graph/stat/05.png';
  levelColor$: Observable<string> = this.playerService.levelColor$;
  backgroundImageUrl: string = `${BASE_URL}/assets/img/cover/19.jpg`;
  headerImagePath = this.baseUrl + '/assets/img/banner/banner-bg.png';
  ...
  ngOnInit(): void {
    ...
    if (this.darkMode) {
      this.headerImagePath = this.baseUrl + '/assets/img/banner/banner-bg-dark.png';
      this.statisticsPath = this.baseUrl + '/assets/img/graph/stat/12.png';
    }
  }
